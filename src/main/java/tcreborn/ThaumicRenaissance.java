...
@Mod(modid = modID, useMetadata = true, version = "1.5.2.2", dependencies = dependencies)
public class ThaumicRenaissance {
    ...
    public static final String dependencies = "required-after:Thaumcraft@[4.2.3.5,);required-after:NemexLib@[1.4,);after:ForbiddenMagic;after:TaintedMagic;after:thaumicbases;after:TwilightForest;after:tc4tweak";
}
